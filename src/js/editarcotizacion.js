...
async function cargarEditarCotizacion() {
    ...
    conexApi.get(`documento/?filter[doc_id]=${id}`).then((res) => {
        ...
        document.getElementById('ftop_id').value = documento.top_id
        document.getElementById('fmtx_id').value = documento.mtx_id
        ...
        document.getElementById('fpais_origen_id').value = documento.pais_origen_id
        ...
        document.getElementById('fpais_destino_id').value = documento.pais_destino_id
    ...
    https://cna-cms.onrender.com/items/detalle_servicio?filter[doc_id]=16
